...
def _get_kwargs(
    *,
    ...
    url = "{}/v3/validate/pf-basica".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, List[Violation], PFBasicaResult]]:
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = PFBasicaResult.from_dict(response.json())

        return response_200
    return None


def _build_response(*, response: httpx.Response) -> Response[Union[Any, List[Violation], PFBasicaResult]]:
    return Response(
