...
def _get_kwargs(
    *,
    ...
    url = "{}/v3/validate/pf-digital".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, List[Violation], PFDigitalResult]]:
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = PFDigitalResult.from_dict(response.json())

        return response_200
    return None


def _build_response(*, response: httpx.Response) -> Response[Union[Any, List[Violation], PFDigitalResult]]:
    return Response(
