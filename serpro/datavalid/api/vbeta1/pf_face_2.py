...
def _get_kwargs(
    *,
    ...
    url = "{}/vbeta1/validate/pf-face".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, List[Violation], PFFaceVbeta1Result]]:
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = PFFaceVbeta1Result.from_dict(response.json())

        return response_200
    return None


def _build_response(*, response: httpx.Response) -> Response[Union[Any, List[Violation], PFFaceVbeta1Result]]:
    return Response(
