...
def _get_kwargs(
    *,
    ...
    url = "{}/v2/validate/pf-digitais".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, List[Violation], PFDigitaisV2Result]]:
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = PFDigitaisV2Result.from_dict(response.json())

        return response_200
    return None


def _build_response(*, response: httpx.Response) -> Response[Union[Any, List[Violation], PFDigitaisV2Result]]:
    return Response(
