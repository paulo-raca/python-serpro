...
def _get_kwargs(
    *,
    ...
    url = "{}/v2/validate/pf".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, List[Violation], PFV2Result]]:
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = PFV2Result.from_dict(response.json())

        return response_200
    return None


def _build_response(*, response: httpx.Response) -> Response[Union[Any, List[Violation], PFV2Result]]:
    return Response(
