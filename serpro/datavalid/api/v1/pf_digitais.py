...
def _get_kwargs(
    *,
    ...
    url = "{}/v1/validate/pf-digitais".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, List[Violation], PFDigitaisV1Result]]:
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = PFDigitaisV1Result.from_dict(response.json())

        return response_200
    return None


def _build_response(*, response: httpx.Response) -> Response[Union[Any, List[Violation], PFDigitaisV1Result]]:
    return Response(
