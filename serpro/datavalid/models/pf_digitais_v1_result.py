...
T = TypeVar("T", bound="PFDigitaisV1Result")


@attr.s(auto_attribs=True)
class PFDigitaisV1Result:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pf_digitais_v1_result.additional_properties = d
        return pf_digitais_v1_result
