...
from ..models.pf_digitais_vbeta_1_answer_nacionalidade import PFDigitaisVbeta1AnswerNacionalidade
from ..models.pf_digitais_vbeta_1_answer_sexo import PFDigitaisVbeta1AnswerSexo
from ..models.pf_digitais_vbeta_1_answer_situacao_cpf import PFDigitaisVbeta1AnswerSituacaoCpf
from ..types import UNSET, Unset

T = TypeVar("T", bound="PFDigitaisVbeta1Answer")


@attr.s(auto_attribs=True)
class PFDigitaisVbeta1Answer:
    """
    Attributes:
        nome (Union[Unset, str]):
        sexo (Union[Unset, PFDigitaisVbeta1AnswerSexo]): F - female, M - male
        nacionalidade (Union[Unset, PFDigitaisVbeta1AnswerNacionalidade]): 1 - brazilian, 2 - naturalized brazilian, 3 -
        ...
        situacao_cpf (Union[Unset, PFDigitaisVbeta1AnswerSituacaoCpf]): regular, suspensa, titular falecido, pendente de
            regularização, cancelada por multiplicidade, nula, cancelada de oficio
    """

    nome: Union[Unset, str] = UNSET
    sexo: Union[Unset, PFDigitaisVbeta1AnswerSexo] = UNSET
    nacionalidade: Union[Unset, PFDigitaisVbeta1AnswerNacionalidade] = UNSET
    ...
    situacao_cpf: Union[Unset, PFDigitaisVbeta1AnswerSituacaoCpf] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sexo: Union[Unset, PFDigitaisVbeta1AnswerSexo]
        if isinstance(_sexo, Unset):
            sexo = UNSET
        else:
            sexo = PFDigitaisVbeta1AnswerSexo(_sexo)

        _nacionalidade = d.pop("nacionalidade", UNSET)
        nacionalidade: Union[Unset, PFDigitaisVbeta1AnswerNacionalidade]
        if isinstance(_nacionalidade, Unset):
            nacionalidade = UNSET
        else:
            nacionalidade = PFDigitaisVbeta1AnswerNacionalidade(_nacionalidade)
        ...
        situacao_cpf: Union[Unset, PFDigitaisVbeta1AnswerSituacaoCpf]
        if isinstance(_situacao_cpf, Unset):
            situacao_cpf = UNSET
        else:
            situacao_cpf = PFDigitaisVbeta1AnswerSituacaoCpf(_situacao_cpf)

        pf_digitais_vbeta_1_answer = cls(
            nome=nome,
            sexo=sexo,
        ...
        pf_digitais_vbeta_1_answer.additional_properties = d
        return pf_digitais_vbeta_1_answer
