...
T = TypeVar("T", bound="PFDigitaisV2Result")


@attr.s(auto_attribs=True)
class PFDigitaisV2Result:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pf_digitais_v2_result.additional_properties = d
        return pf_digitais_v2_result
