...
from ..models.pf_digitais_v2_answer_nacionalidade import PFDigitaisV2AnswerNacionalidade
from ..models.pf_digitais_v2_answer_sexo import PFDigitaisV2AnswerSexo
from ..models.pf_digitais_v2_answer_situacao_cpf import PFDigitaisV2AnswerSituacaoCpf
from ..types import UNSET, Unset

T = TypeVar("T", bound="PFDigitaisV2Answer")


@attr.s(auto_attribs=True)
class PFDigitaisV2Answer:
    """
    Attributes:
        nome (Union[Unset, str]):
        sexo (Union[Unset, PFDigitaisV2AnswerSexo]): F - female, M - male
        nacionalidade (Union[Unset, PFDigitaisV2AnswerNacionalidade]): 1 - brazilian, 2 - naturalized brazilian, 3 -
        ...
        situacao_cpf (Union[Unset, PFDigitaisV2AnswerSituacaoCpf]): regular, suspensa, titular falecido, pendente de
            regularização, cancelada por multiplicidade, nula, cancelada de oficio
    """

    nome: Union[Unset, str] = UNSET
    sexo: Union[Unset, PFDigitaisV2AnswerSexo] = UNSET
    nacionalidade: Union[Unset, PFDigitaisV2AnswerNacionalidade] = UNSET
    ...
    situacao_cpf: Union[Unset, PFDigitaisV2AnswerSituacaoCpf] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sexo: Union[Unset, PFDigitaisV2AnswerSexo]
        if isinstance(_sexo, Unset):
            sexo = UNSET
        else:
            sexo = PFDigitaisV2AnswerSexo(_sexo)

        _nacionalidade = d.pop("nacionalidade", UNSET)
        nacionalidade: Union[Unset, PFDigitaisV2AnswerNacionalidade]
        if isinstance(_nacionalidade, Unset):
            nacionalidade = UNSET
        else:
            nacionalidade = PFDigitaisV2AnswerNacionalidade(_nacionalidade)
        ...
        situacao_cpf: Union[Unset, PFDigitaisV2AnswerSituacaoCpf]
        if isinstance(_situacao_cpf, Unset):
            situacao_cpf = UNSET
        else:
            situacao_cpf = PFDigitaisV2AnswerSituacaoCpf(_situacao_cpf)

        pf_digitais_v2_answer = cls(
            nome=nome,
            sexo=sexo,
        ...
        pf_digitais_v2_answer.additional_properties = d
        return pf_digitais_v2_answer
