...
from ..models.pf_imagem_v1_answer_nacionalidade import PFImagemV1AnswerNacionalidade
from ..models.pf_imagem_v1_answer_sexo import PFImagemV1AnswerSexo
from ..models.pf_imagem_v1_answer_situacao_cpf import PFImagemV1AnswerSituacaoCpf
from ..types import UNSET, Unset

T = TypeVar("T", bound="PFImagemV1Answer")


@attr.s(auto_attribs=True)
class PFImagemV1Answer:
    """
    Attributes:
        nome (Union[Unset, str]):
        sexo (Union[Unset, PFImagemV1AnswerSexo]): F - female, M - male
        nacionalidade (Union[Unset, PFImagemV1AnswerNacionalidade]): 1 - brazilian, 2 - naturalized brazilian, 3 -
        ...
        situacao_cpf (Union[Unset, PFImagemV1AnswerSituacaoCpf]): regular, suspensa, titular falecido, pendente de
    ...
    sexo: Union[Unset, PFImagemV1AnswerSexo] = UNSET
    nacionalidade: Union[Unset, PFImagemV1AnswerNacionalidade] = UNSET
    ...
    situacao_cpf: Union[Unset, PFImagemV1AnswerSituacaoCpf] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sexo: Union[Unset, PFImagemV1AnswerSexo]
        if isinstance(_sexo, Unset):
            sexo = UNSET
        else:
            sexo = PFImagemV1AnswerSexo(_sexo)

        _nacionalidade = d.pop("nacionalidade", UNSET)
        nacionalidade: Union[Unset, PFImagemV1AnswerNacionalidade]
        if isinstance(_nacionalidade, Unset):
            nacionalidade = UNSET
        else:
            nacionalidade = PFImagemV1AnswerNacionalidade(_nacionalidade)
        ...
        situacao_cpf: Union[Unset, PFImagemV1AnswerSituacaoCpf]
        if isinstance(_situacao_cpf, Unset):
            situacao_cpf = UNSET
        else:
            situacao_cpf = PFImagemV1AnswerSituacaoCpf(_situacao_cpf)

        biometria_face = d.pop("biometria_face", UNSET)

        pf_imagem_v1_answer = cls(
            nome=nome,
            sexo=sexo,
        ...
        pf_imagem_v1_answer.additional_properties = d
        return pf_imagem_v1_answer
