...
from ..models.pf_imagem_v2_answer_nacionalidade import PFImagemV2AnswerNacionalidade
from ..models.pf_imagem_v2_answer_sexo import PFImagemV2AnswerSexo
from ..models.pf_imagem_v2_answer_situacao_cpf import PFImagemV2AnswerSituacaoCpf
from ..types import UNSET, Unset

T = TypeVar("T", bound="PFImagemV2Answer")


@attr.s(auto_attribs=True)
class PFImagemV2Answer:
    """
    Attributes:
        nome (Union[Unset, str]):
        sexo (Union[Unset, PFImagemV2AnswerSexo]): F - female, M - male
        nacionalidade (Union[Unset, PFImagemV2AnswerNacionalidade]): 1 - brazilian, 2 - naturalized brazilian, 3 -
        ...
        situacao_cpf (Union[Unset, PFImagemV2AnswerSituacaoCpf]): regular, suspensa, titular falecido, pendente de
    ...
    sexo: Union[Unset, PFImagemV2AnswerSexo] = UNSET
    nacionalidade: Union[Unset, PFImagemV2AnswerNacionalidade] = UNSET
    ...
    situacao_cpf: Union[Unset, PFImagemV2AnswerSituacaoCpf] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sexo: Union[Unset, PFImagemV2AnswerSexo]
        if isinstance(_sexo, Unset):
            sexo = UNSET
        else:
            sexo = PFImagemV2AnswerSexo(_sexo)

        _nacionalidade = d.pop("nacionalidade", UNSET)
        nacionalidade: Union[Unset, PFImagemV2AnswerNacionalidade]
        if isinstance(_nacionalidade, Unset):
            nacionalidade = UNSET
        else:
            nacionalidade = PFImagemV2AnswerNacionalidade(_nacionalidade)
        ...
        situacao_cpf: Union[Unset, PFImagemV2AnswerSituacaoCpf]
        if isinstance(_situacao_cpf, Unset):
            situacao_cpf = UNSET
        else:
            situacao_cpf = PFImagemV2AnswerSituacaoCpf(_situacao_cpf)

        biometria_face = d.pop("biometria_face", UNSET)

        pf_imagem_v2_answer = cls(
            nome=nome,
            sexo=sexo,
        ...
        pf_imagem_v2_answer.additional_properties = d
        return pf_imagem_v2_answer
