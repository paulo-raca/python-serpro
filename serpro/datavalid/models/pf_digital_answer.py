...
from ..models.pf_digital_answer_nacionalidade import PFDigitalAnswerNacionalidade
from ..models.pf_digital_answer_sexo import PFDigitalAnswerSexo
from ..models.pf_digital_answer_situacao_cpf import PFDigitalAnswerSituacaoCpf
from ..types import UNSET, Unset

T = TypeVar("T", bound="PFDigitalAnswer")


@attr.s(auto_attribs=True)
class PFDigitalAnswer:
    """
    Attributes:
        nome (Union[Unset, str]):
        data_nascimento (Union[Unset, datetime.date]):
        situacao_cpf (Union[Unset, PFDigitalAnswerSituacaoCpf]): regular, suspensa, titular falecido, pendente de
            regularização, cancelada por multiplicidade, nula, cancelada de oficio
        sexo (Union[Unset, PFDigitalAnswerSexo]): F - female, M - male
        nacionalidade (Union[Unset, PFDigitalAnswerNacionalidade]): 1 - brazilian, 2 - naturalized brazilian, 3 -
    ...
    situacao_cpf: Union[Unset, PFDigitalAnswerSituacaoCpf] = UNSET
    sexo: Union[Unset, PFDigitalAnswerSexo] = UNSET
    nacionalidade: Union[Unset, PFDigitalAnswerNacionalidade] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        situacao_cpf: Union[Unset, PFDigitalAnswerSituacaoCpf]
        if isinstance(_situacao_cpf, Unset):
            situacao_cpf = UNSET
        else:
            situacao_cpf = PFDigitalAnswerSituacaoCpf(_situacao_cpf)

        _sexo = d.pop("sexo", UNSET)
        sexo: Union[Unset, PFDigitalAnswerSexo]
        if isinstance(_sexo, Unset):
            sexo = UNSET
        else:
            sexo = PFDigitalAnswerSexo(_sexo)

        _nacionalidade = d.pop("nacionalidade", UNSET)
        nacionalidade: Union[Unset, PFDigitalAnswerNacionalidade]
        if isinstance(_nacionalidade, Unset):
            nacionalidade = UNSET
        else:
            nacionalidade = PFDigitalAnswerNacionalidade(_nacionalidade)
        ...
        pf_digital_answer.additional_properties = d
        return pf_digital_answer
