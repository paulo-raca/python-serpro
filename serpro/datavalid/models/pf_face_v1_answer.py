...
from ..models.pf_face_v1_answer_nacionalidade import PFFaceV1AnswerNacionalidade
from ..models.pf_face_v1_answer_sexo import PFFaceV1AnswerSexo
from ..models.pf_face_v1_answer_situacao_cpf import PFFaceV1AnswerSituacaoCpf
from ..types import UNSET, Unset

T = TypeVar("T", bound="PFFaceV1Answer")


@attr.s(auto_attribs=True)
class PFFaceV1Answer:
    """
    Attributes:
        nome (Union[Unset, str]):
        sexo (Union[Unset, PFFaceV1AnswerSexo]): F - female, M - male
        nacionalidade (Union[Unset, PFFaceV1AnswerNacionalidade]): 1 - brazilian, 2 - naturalized brazilian, 3 -
        ...
        situacao_cpf (Union[Unset, PFFaceV1AnswerSituacaoCpf]): regular, suspensa, titular falecido, pendente de
    ...
    sexo: Union[Unset, PFFaceV1AnswerSexo] = UNSET
    nacionalidade: Union[Unset, PFFaceV1AnswerNacionalidade] = UNSET
    ...
    situacao_cpf: Union[Unset, PFFaceV1AnswerSituacaoCpf] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sexo: Union[Unset, PFFaceV1AnswerSexo]
        if isinstance(_sexo, Unset):
            sexo = UNSET
        else:
            sexo = PFFaceV1AnswerSexo(_sexo)

        _nacionalidade = d.pop("nacionalidade", UNSET)
        nacionalidade: Union[Unset, PFFaceV1AnswerNacionalidade]
        if isinstance(_nacionalidade, Unset):
            nacionalidade = UNSET
        else:
            nacionalidade = PFFaceV1AnswerNacionalidade(_nacionalidade)
        ...
        situacao_cpf: Union[Unset, PFFaceV1AnswerSituacaoCpf]
        if isinstance(_situacao_cpf, Unset):
            situacao_cpf = UNSET
        else:
            situacao_cpf = PFFaceV1AnswerSituacaoCpf(_situacao_cpf)

        biometria_face = d.pop("biometria_face", UNSET)

        pf_face_v1_answer = cls(
            nome=nome,
            sexo=sexo,
        ...
        pf_face_v1_answer.additional_properties = d
        return pf_face_v1_answer
