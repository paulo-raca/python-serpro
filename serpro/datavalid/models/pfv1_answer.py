...
from ..models.pfv1_answer_nacionalidade import PFV1AnswerNacionalidade
from ..models.pfv1_answer_sexo import PFV1AnswerSexo
from ..models.pfv1_answer_situacao_cpf import PFV1AnswerSituacaoCpf
from ..types import UNSET, Unset

T = TypeVar("T", bound="PFV1Answer")
...
class PFV1Answer:
    ...
    Attributes:
        ...
        sexo (Union[Unset, PFV1AnswerSexo]): F - female, M - male
        nacionalidade (Union[Unset, PFV1AnswerNacionalidade]): 1 - brazilian, 2 - naturalized brazilian, 3 - foreigner,
        ...
        situacao_cpf (Union[Unset, PFV1AnswerSituacaoCpf]): regular, suspensa, titular falecido, pendente de
            regularização, cancelada por multiplicidade, nula, cancelada de oficio
    """

    nome: Union[Unset, str] = UNSET
    sexo: Union[Unset, PFV1AnswerSexo] = UNSET
    nacionalidade: Union[Unset, PFV1AnswerNacionalidade] = UNSET
    ...
    situacao_cpf: Union[Unset, PFV1AnswerSituacaoCpf] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sexo: Union[Unset, PFV1AnswerSexo]
        if isinstance(_sexo, Unset):
            sexo = UNSET
        else:
            sexo = PFV1AnswerSexo(_sexo)

        _nacionalidade = d.pop("nacionalidade", UNSET)
        nacionalidade: Union[Unset, PFV1AnswerNacionalidade]
        if isinstance(_nacionalidade, Unset):
            nacionalidade = UNSET
        else:
            nacionalidade = PFV1AnswerNacionalidade(_nacionalidade)
        ...
        situacao_cpf: Union[Unset, PFV1AnswerSituacaoCpf]
        if isinstance(_situacao_cpf, Unset):
            situacao_cpf = UNSET
        else:
            situacao_cpf = PFV1AnswerSituacaoCpf(_situacao_cpf)
        ...
        pfv1_answer.additional_properties = d
        return pfv1_answer
