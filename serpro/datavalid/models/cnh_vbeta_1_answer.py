...
from ..models.cnh_vbeta_1_answer_codigo_situacao import CNHVbeta1AnswerCodigoSituacao
from ..models.cnh_vbeta_1_answer_descricao_situacao import CNHVbeta1AnswerDescricaoSituacao
from ..types import UNSET, Unset

T = TypeVar("T", bound="CNHVbeta1Answer")


@attr.s(auto_attribs=True)
class CNHVbeta1Answer:
    """
    Attributes:
        ...
        codigo_situacao (Union[Unset, CNHVbeta1AnswerCodigoSituacao]): 2 - in issue, 3 - issued, A - canceled
        descricao_situacao (Union[Unset, CNHVbeta1AnswerDescricaoSituacao]): em emissão, emitida, cancelada
    """
    ...
    codigo_situacao: Union[Unset, CNHVbeta1AnswerCodigoSituacao] = UNSET
    descricao_situacao: Union[Unset, CNHVbeta1AnswerDescricaoSituacao] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        descricao_situacao: Union[Unset, str] = UNSET
        if not isinstance(self.descricao_situacao, Unset):
            descricao_situacao = self.descricao_situacao.value
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        codigo_situacao: Union[Unset, CNHVbeta1AnswerCodigoSituacao]
        if isinstance(_codigo_situacao, Unset):
            codigo_situacao = UNSET
        else:
            codigo_situacao = CNHVbeta1AnswerCodigoSituacao(_codigo_situacao)

        _descricao_situacao = d.pop("descricao_situacao", UNSET)
        descricao_situacao: Union[Unset, CNHVbeta1AnswerDescricaoSituacao]
        if isinstance(_descricao_situacao, Unset):
            descricao_situacao = UNSET
        else:
            descricao_situacao = CNHVbeta1AnswerDescricaoSituacao(_descricao_situacao)

        cnh_vbeta_1_answer = cls(
            categoria=categoria,
        ...
        cnh_vbeta_1_answer.additional_properties = d
        return cnh_vbeta_1_answer
