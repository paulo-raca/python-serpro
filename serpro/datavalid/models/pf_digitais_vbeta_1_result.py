...
from ..models.cnh_biometry_vbeta_1_result import CNHBiometryVbeta1Result
from ..models.digitais_result import DigitaisResult
from ..models.documento_vbeta_1_result import DocumentoVbeta1Result
from ..models.endereco_result import EnderecoResult
from ..models.filiacao_result import FiliacaoResult
from ..types import UNSET, Unset

T = TypeVar("T", bound="PFDigitaisVbeta1Result")


@attr.s(auto_attribs=True)
class PFDigitaisVbeta1Result:
    """
    Attributes:
        ...
        documento (Union[Unset, DocumentoVbeta1Result]):
        cnh (Union[Unset, CNHBiometryVbeta1Result]):
    ...
    documento: Union[Unset, DocumentoVbeta1Result] = UNSET
    cnh: Union[Unset, CNHBiometryVbeta1Result] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_documento, Unset):
            ...
            documento = DocumentoVbeta1Result.from_dict(_documento)
        ...
        if isinstance(_cnh, Unset):
            ...
            cnh = CNHBiometryVbeta1Result.from_dict(_cnh)
        ...
        pf_digitais_vbeta_1_result = cls(
            nome=nome,
            sexo=sexo,
        ...
        pf_digitais_vbeta_1_result.additional_properties = d
        return pf_digitais_vbeta_1_result
