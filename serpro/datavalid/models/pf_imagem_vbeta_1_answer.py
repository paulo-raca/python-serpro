...
from ..models.pf_imagem_vbeta_1_answer_nacionalidade import PFImagemVbeta1AnswerNacionalidade
from ..models.pf_imagem_vbeta_1_answer_sexo import PFImagemVbeta1AnswerSexo
from ..models.pf_imagem_vbeta_1_answer_situacao_cpf import PFImagemVbeta1AnswerSituacaoCpf
from ..types import UNSET, Unset

T = TypeVar("T", bound="PFImagemVbeta1Answer")


@attr.s(auto_attribs=True)
class PFImagemVbeta1Answer:
    """
    Attributes:
        nome (Union[Unset, str]):
        sexo (Union[Unset, PFImagemVbeta1AnswerSexo]): F - female, M - male
        nacionalidade (Union[Unset, PFImagemVbeta1AnswerNacionalidade]): 1 - brazilian, 2 - naturalized brazilian, 3 -
        ...
        situacao_cpf (Union[Unset, PFImagemVbeta1AnswerSituacaoCpf]): regular, suspensa, titular falecido, pendente de
    ...
    sexo: Union[Unset, PFImagemVbeta1AnswerSexo] = UNSET
    nacionalidade: Union[Unset, PFImagemVbeta1AnswerNacionalidade] = UNSET
    ...
    situacao_cpf: Union[Unset, PFImagemVbeta1AnswerSituacaoCpf] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sexo: Union[Unset, PFImagemVbeta1AnswerSexo]
        if isinstance(_sexo, Unset):
            sexo = UNSET
        else:
            sexo = PFImagemVbeta1AnswerSexo(_sexo)

        _nacionalidade = d.pop("nacionalidade", UNSET)
        nacionalidade: Union[Unset, PFImagemVbeta1AnswerNacionalidade]
        if isinstance(_nacionalidade, Unset):
            nacionalidade = UNSET
        else:
            nacionalidade = PFImagemVbeta1AnswerNacionalidade(_nacionalidade)
        ...
        situacao_cpf: Union[Unset, PFImagemVbeta1AnswerSituacaoCpf]
        if isinstance(_situacao_cpf, Unset):
            situacao_cpf = UNSET
        else:
            situacao_cpf = PFImagemVbeta1AnswerSituacaoCpf(_situacao_cpf)

        biometria_face = d.pop("biometria_face", UNSET)

        pf_imagem_vbeta_1_answer = cls(
            nome=nome,
            sexo=sexo,
        ...
        pf_imagem_vbeta_1_answer.additional_properties = d
        return pf_imagem_vbeta_1_answer
