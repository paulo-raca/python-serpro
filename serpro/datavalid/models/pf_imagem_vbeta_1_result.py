...
T = TypeVar("T", bound="PFImagemVbeta1Result")


@attr.s(auto_attribs=True)
class PFImagemVbeta1Result:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pf_imagem_vbeta_1_result.additional_properties = d
        return pf_imagem_vbeta_1_result
