...
from ..models.face_answer_formato import FaceAnswerFormato
from ..types import UNSET, Unset

T = TypeVar("T", bound="FaceAnswer")
...
class FaceAnswer:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_formato, Unset):
            ...
            formato = FaceAnswerFormato(_formato)
        ...
        face_answer.additional_properties = d
        return face_answer
