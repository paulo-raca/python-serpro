...
T = TypeVar("T", bound="PFFaceVbeta1Result")


@attr.s(auto_attribs=True)
class PFFaceVbeta1Result:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pf_face_vbeta_1_result.additional_properties = d
        return pf_face_vbeta_1_result
