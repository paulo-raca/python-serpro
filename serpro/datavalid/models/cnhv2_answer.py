...
from ..models.cnhv2_answer_codigo_situacao import CNHV2AnswerCodigoSituacao
from ..types import UNSET, Unset

T = TypeVar("T", bound="CNHV2Answer")
...
class CNHV2Answer:
    ...
    Attributes:
        ...
        codigo_situacao (Union[Unset, CNHV2AnswerCodigoSituacao]): 2 - in issue, 3 - issued, A - canceled
    ...
    codigo_situacao: Union[Unset, CNHV2AnswerCodigoSituacao] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        codigo_situacao: Union[Unset, CNHV2AnswerCodigoSituacao]
        if isinstance(_codigo_situacao, Unset):
            codigo_situacao = UNSET
        else:
            codigo_situacao = CNHV2AnswerCodigoSituacao(_codigo_situacao)
        ...
        cnhv2_answer.additional_properties = d
        return cnhv2_answer
