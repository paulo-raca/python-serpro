...
from ..models.cnh_vbeta_1_result import CNHVbeta1Result
...
T = TypeVar("T", bound="PFVbeta1Result")


@attr.s(auto_attribs=True)
class PFVbeta1Result:
    """
    Attributes:
        ...
        cnh (Union[Unset, CNHVbeta1Result]):
    ...
    cnh: Union[Unset, CNHVbeta1Result] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_cnh, Unset):
            ...
            cnh = CNHVbeta1Result.from_dict(_cnh)
        ...
        pf_vbeta_1_result.additional_properties = d
        return pf_vbeta_1_result
